...
class AuthRequests {
     ...
     */
    persistToken(token, username, idUsuario, isAuth) {
        ...
        // adiciona o id da pessoa no localstorade com o apelido de idUsuario
        localStorage.setItem('idUsuario', idUsuario);  // -> armazena o idUsuario no localStorage e coloca o 'apelido' de idUsuario
    ...
    removeToken() {
        ...
        localStorage.removeItem('idUsuario');  // -> remove o 'apelido' de idUsuario do localStorage
