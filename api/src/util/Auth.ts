 ...
 * @returns Resposta com sucesso de logout
 */
static logout(req: Request, res: Response): Response {
    // Apenas informa que o logout foi realizado, o cliente deve remover o token
    return res.status(200).json({ auth: false, token: null, message: "Logout realizado com sucesso" });
}
